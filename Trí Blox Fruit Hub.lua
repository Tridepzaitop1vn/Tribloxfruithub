...
ImageButton.Image = "rbxassetid://16249709414"
...
local NotiFrame = Instance.new("Frame")
	...
	DiscordLib:Notification("Thông Báo" , "Thằng nào có tiền cày thuê ủng hộ tao" , 6 ,11816162894 )
	DiscordLib:Notification("Thông Báo" , "ib Fb hoặc zalo" , 6 ,11816162894 )
...
Main:Toggle("Auto đánh Nhà Máy",_G.AutoFactory,function(value)
...
Main:Seperator("Chest")    
    Main:Toggle("Auto Chest ( 100% Reset Acc nên đừng dùng )",_G.chestsea3,function(value)
 _G.chestsea3 = value
...
StopTween(_G.Auto_Open_Dough_Dungeon)
	...
	if World3 then
	Main:Toggle("Farm Bột socola",_G.Cacao,function(value)
 _G.Cacao = value
 _G.click = value
StopTween(_G.Cacao)
end)
...
Weapon:Seperator(" Haki Màu ")
	...
	Weapon:Toggle("Auto Mua Haki Màu",_G.Auto_Buy_Enchancement,function(value)
...
Race:Toggle("Bay Vào Đảo Bí Ẩn",false,function(value)
...
Race:Button("Bay Đến Cổng Tộc Của Bản Thân",function()
 ...
 Race:Button("bay Đến Chỗ Gắn Gear",function()
for _,v in next, workspace:GetDescendants() do
 ...
 Race:Seperator("Auto thắng trial V4")
  Race:Toggle("Win tria l tất cả Tộc",_G.winv4,function(value)
 _G.winv4 = value
 StopTween(_G.winv4)
end)
spawn(function()
...
Race:Toggle("tự động Đánh Sea Beasts Tộc Cá",_G.SeaBeasts1,function(value)
 _G.SeaBeasts1 = value
 StopTween(_G.SeaBeasts1)
end)
...
Race:Seperator("Buy + Bật Tộc by trí") 
 
 
  
   Race:Toggle("Tự kích hoạt Bật V4 by trí",_G.Auto_Farm_Bone3,function(value)
...
Race:Toggle("Tự Động mua Train by trí",_G.Auto_Farm_Bone4,function(value)
...
Race:Button("Dịch Chuyển Đến Npc Mua Train by trí",function()
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
...
DiscordLib:Notification("Thông Báo" , "Nhân Phẩm Của Bạn đã Lên 1000% Và auto ra fruit xịn" , 10 ,11816162894 )
  end)
 ...
 DevilFruit:Toggle("Tự Động Th ả Fruit",_G.DropFruit,function(value)
  _G.DropFruit = value
  end)
...
TextLabel.Font = Enum.Font.SourceSans
TextLabel.Text = "Trí Blox Fruit Hub"
TextLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
